...
if (Get-DCU-Installed - eq $true) 
    {
        ...
        $RegValueJSON = Switch-JSON -JSONValue ($RegValue | ConvertTo-Json -Compress) -JSONName "RegValueJSON"
        $IgnoreListCurrentJSON = Switch-JSON -JSONValue ($IgnoreListCurrent | ConvertTo-Json -Compress) -JSONName "IgnoreListCurrentJSON"
